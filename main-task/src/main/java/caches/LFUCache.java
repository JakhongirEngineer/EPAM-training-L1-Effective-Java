...
public class LFUCache {
    ...
    private final ConcurrentHashMap<Integer, Integer> keyToVal;
    private final ConcurrentHashMap<Integer, Integer> keyToCount;
    private final ConcurrentHashMap<Integer, LinkedHashSet<Integer>> countToLRUKeys;

    public LFUCache(int capacity) {
        this.min = -1;
        this.capacity = capacity;
        this.keyToVal = new ConcurrentHashMap<>();
        this.keyToCount = new ConcurrentHashMap<>();
        this.countToLRUKeys = new ConcurrentHashMap<>();
    }
